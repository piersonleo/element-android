...
abstract class MergedRoomCreationItemVchat : BasedMergedItem<MergedRoomCreationItemVchat.Holder>() {
    ...
    override fun bind(holder: Holder) {
        ...
        if (attributes.isCollapsed) {
            ...
            val summary = if (createdFromCurrentUser) {
                ...
                if (data?.isDirectRoom == true) {
                    holder.expandView.resources.getString(R.string.direct_room_created_summary_item, Utils.removeUrlSuffix(data.memberName))
                } else {
                    holder.expandView.resources.getString(R.string.room_created_summary_item, Utils.removeUrlSuffix(data?.memberName) ?: Utils.removeUrlSuffix(data?.userId) ?: "")
                }
            }
