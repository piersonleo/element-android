...
class VectorRoomDisplayNameFallbackProviderVchat @Inject constructor(
    ...
    override fun getNameForEmptyRoom(isDirect: Boolean, leftMemberNames: List<String>): String {
        return if (leftMemberNames.isEmpty()) {
            context.getString(R.string.vchat_room_displayname_empty_room)
        } else {
...
//            }
            context.getString(R.string.vchat_room_displayname_empty_room_was)
        }
    }

    override fun getNameFor1member(name: String) = name.removeSuffix(Constants.URL_SUFFIX)

    override fun getNameFor2members(name1: String, name2: String): String {
        return context.getString(R.string.room_displayname_two_members, Utils.removeUrlSuffix(name1), Utils.removeUrlSuffix(name2))
    }

    override fun getNameFor3members(name1: String, name2: String, name3: String): String {
        return context.getString(R.string.room_displayname_3_members, Utils.removeUrlSuffix(name1), Utils.removeUrlSuffix(name2), Utils.removeUrlSuffix(name3))
    }

    override fun getNameFor4members(name1: String, name2: String, name3: String, name4: String): String {
        return context.getString(R.string.room_displayname_4_members, Utils.removeUrlSuffix(name1), Utils.removeUrlSuffix(name2), Utils.removeUrlSuffix(name3), Utils.removeUrlSuffix(name4))
    }
    ...
    override fun getNameFor4membersAndMore(name1: String, name2: String, name3: String, remainingCount: Int): String {
        return context.resources.getQuantityString(
                ...
                remainingCount,
                Utils.removeUrlSuffix(name1),
                Utils.removeUrlSuffix(name2),
                Utils.removeUrlSuffix(name3),
                remainingCount
        )
    }
}
